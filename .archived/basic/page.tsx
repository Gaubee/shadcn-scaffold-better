...
import { BottomNavigationBar } from "@/components/scaffold/bottom-navigation-bar";
          ...
          <div className="container mx-auto px-4 py-8 pb-24">
            <div className="mx-auto max-w-4xl space-y-8">
              ...
              <section className="py-8 text-center">
                <h2 className="from-primary mb-4 bg-linear-to-r to-purple-600 bg-clip-text text-4xl font-bold text-transparent">
              ...
              <section className="grid gap-4 md:grid-cols-3">
                <div className="rounded-lg border-2 border-blue-200 bg-linear-to-br from-blue-50/80 to-white p-6 dark:border-blue-800 dark:from-blue-950 dark:to-blue-900/50">
                ...
                <div className="rounded-lg border-2 border-purple-200 bg-linear-to-br from-purple-50/80 to-white p-6 dark:border-purple-800 dark:from-purple-950 dark:to-purple-900/50">
                  <div className="mb-2 flex items-center gap-3">
                ...
                <div className="rounded-lg border-2 border-green-200 bg-linear-to-br from-green-50/80 to-white p-6 dark:border-green-800 dark:from-green-950 dark:to-green-900/50">
                  <div className="mb-2 flex items-center gap-3">
                  ...
                  <article
                    ...
                    <div className="mb-3 flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        <div className="from-primary text-primary-foreground flex h-10 w-10 items-center justify-center rounded-full bg-linear-to-br to-purple-600 font-bold">
                          {post.author[0]}
                        </div>
                        <div>
