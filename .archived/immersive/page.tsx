      ...
      <Scaffold
        ...
        list={() => (
          <div className="relative">
            ...
            <div
              className="relative flex h-[70vh] items-center justify-center overflow-hidden bg-linear-to-br from-blue-600 via-purple-600 to-pink-500"
              style={{
              ...
              <div className="mx-auto max-w-3xl space-y-8">
                ...
                <section>
                  ...
                  <p className="text-muted-foreground mb-6 text-lg leading-relaxed">
                    This page demonstrates the immersive AppBar feature, a powerful design pattern that creates a
                    seamless connection between your hero content and navigation. As you scroll, watch the AppBar
                    gradually become opaque with a sophisticated backdrop blur effect.
                  </p>
                  <div className="rounded-xl border bg-linear-to-r from-blue-50 to-purple-50 p-6 dark:from-blue-950 dark:to-purple-950">
                  ...
                  <div className="grid gap-4">
                    <div className="rounded-xl border p-6 transition-all hover:shadow-lg">
                      ...
                      <p className="text-muted-foreground">
                        The AppBar starts completely transparent, allowing your hero content to shine. As users scroll,
                        it smoothly transitions to a solid state with perfect readability.
                      </p>
                    </div>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground mb-4">
                    Creating an immersive experience is straightforward with Scaffold UI. Here's the code that powers
                    this page:
                  </p>
                  <div className="relative">
...
/>`}</code>
                ...
                <section>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mb-4 leading-relaxed">
                        We use a cubic-bezier easing function (ease-out-quart) for natural-feeling transitions. The
                        scroll progress is calculated with careful consideration for different viewport sizes and
                        content heights.
                      </p>
                    </div>
                ...
                {Array.from({ length: 6 }).map((_, i) => (
                  <section key={i} className="from-background to-muted/30 rounded-xl border bg-linear-to-br p-8">
                    ...
                    <p className="text-muted-foreground mb-4 leading-relaxed">
                      ...
                      entire scroll journey. The backdrop blur intensifies gradually, creating a seamless visual
                      hierarchy that guides the reader's attention.
                    </p>
                    <p className="text-muted-foreground mb-4 leading-relaxed">
