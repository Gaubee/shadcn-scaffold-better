...
export default function ResponsiveExamplePage() {
  ...
  const navigationItems = [
    ...
    { key: 'analytics', icon: <BarChart3 size={24} />, label: 'Analytics', badge: 2 },
    { key: 'messages', icon: <MessageSquare size={24} />, label: 'Messages', badge: 5 },
    { key: 'calendar', icon: <Calendar size={24} />, label: 'Calendar' },
    { key: 'profile', icon: <User size={24} />, label: 'Profile' },
  ];

  const contentItems = [
    { id: 1, icon: <FileText className="text-blue-500" />, title: 'Project Proposal', type: 'Document', size: '2.4 MB', modified: '2 hours ago', color: 'blue' },
    { id: 2, icon: <Image className="text-purple-500" />, title: 'Design Assets', type: 'Image', size: '15.8 MB', modified: '5 hours ago', color: 'purple' },
    { id: 3, icon: <Video className="text-red-500" />, title: 'Tutorial Video', type: 'Video', size: '125 MB', modified: '1 day ago', color: 'red' },
    { id: 4, icon: <Music className="text-green-500" />, title: 'Podcast Episode', type: 'Audio', size: '45 MB', modified: '2 days ago', color: 'green' },
    { id: 5, icon: <Folder className="text-yellow-500" />, title: 'Resources', type: 'Folder', size: '256 MB', modified: '3 days ago', color: 'yellow' },
    { id: 6, icon: <FileText className="text-cyan-500" />, title: 'Meeting Notes', type: 'Document', size: '1.2 MB', modified: '4 days ago', color: 'cyan' },
  ];
            ...
            <div className="flex flex-col h-full">
              ...
              <nav className="flex-1 p-4 overflow-y-auto">
                  ...
                  {navigationItems.map((item) => (
                    <button
                      ...
                      onClick={() => {
                        ...
                        setDrawerOpen(false);
                        snackbar.show(`Switched to ${item.label}`, { severity: 'default' });
                      }}
                ...
                <div className="mt-6 pt-6 border-t">
                  <h4 className="px-4 text-xs font-semibold text-muted-foreground uppercase mb-2">
                    Storage
                  </h4>
              ...
              <div className="p-4 border-t space-y-2">
                <button
                  onClick={() => {
                    setDrawerOpen(false);
                    snackbar.show('Upgrade feature coming soon', { severity: 'info' });
                  }}
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <section>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Experience how the layout seamlessly adapts to different screen sizes.
                Try resizing your browser window to see the navigation transform
                between Drawer and NavigationRail modes.
              </p>

              {/* Device Type Indicators */}
              <div className="grid gap-4 md:grid-cols-3">
                <div className={`p-6 border rounded-xl transition-all ${
                  deviceType === 'mobile' ? 'bg-blue-50 dark:bg-blue-950 border-blue-500 shadow-lg scale-105' : 'hover:shadow-md'
                }`}>
                  <div className="flex items-center gap-3 mb-3">
                    <Smartphone className={deviceType === 'mobile' ? 'text-blue-500' : 'text-muted-foreground'} size={24} />
                  ...
                  <p className="text-sm text-muted-foreground">
                    &lt; 768px - Drawer navigation with menu button
                  </p>
                </div>

                <div className={`p-6 border rounded-xl transition-all ${
                  deviceType === 'tablet' ? 'bg-purple-50 dark:bg-purple-950 border-purple-500 shadow-lg scale-105' : 'hover:shadow-md'
                }`}>
                  <div className="flex items-center gap-3 mb-3">
                    <Tablet className={deviceType === 'tablet' ? 'text-purple-500' : 'text-muted-foreground'} size={24} />
                  ...
                  <p className="text-sm text-muted-foreground">
                    768px - 1023px - Transitioning layout
                  </p>
                </div>

                <div className={`p-6 border rounded-xl transition-all ${
                  deviceType === 'desktop' ? 'bg-green-50 dark:bg-green-950 border-green-500 shadow-lg scale-105' : 'hover:shadow-md'
                }`}>
                  <div className="flex items-center gap-3 mb-3">
                    <Monitor className={deviceType === 'desktop' ? 'text-green-500' : 'text-muted-foreground'} size={24} />
                  ...
                  <p className="text-sm text-muted-foreground">
                    ≥ 1024px - NavigationRail with persistent sidebar
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={() => {
                      setViewMode('grid');
                      snackbar.show('Switched to grid view', { severity: 'default' });
                    }}
                  ...
                  <button
                    onClick={() => {
                      setViewMode('list');
                      snackbar.show('Switched to list view', { severity: 'default' });
                    }}
                    className={`p-2 rounded-lg transition-all ${
                      viewMode === 'list'
                        ? 'bg-primary text-primary-foreground shadow-md'
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            snackbar.show('Download started', { severity: 'success' });
                          }}
                          className="p-2 hover:bg-accent rounded-full transition-colors"
                          aria-label="Download"
                        >
            ...
            <section className="space-y-4 pt-8 border-t">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="p-6 border rounded-xl hover:shadow-lg transition-all">
                  ...
                  <p className="text-sm text-muted-foreground">
                    The Scaffold intelligently switches between Drawer and NavigationRail
                    based on screen size, providing optimal UX for each device type.
                  </p>
                </div>
                ...
                <div className="p-6 border rounded-xl hover:shadow-lg transition-all">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Content seamlessly adapts with fluid animations when the layout
                    changes, maintaining context and user focus throughout.
                  </p>
                </div>
                ...
                <div className="p-6 border rounded-xl hover:shadow-lg transition-all">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Navigation items remain consistent across all screen sizes,
                    ensuring users always know where they are and how to navigate.
                  </p>
                </div>
                ...
                <div className="p-6 border rounded-xl hover:shadow-lg transition-all">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Fine-tune the responsive behavior by adjusting the breakpoint
                    to match your application's specific needs (default: 1024px).
                  </p>
                </div>
              </div>
            </section>
  ...
  {/* Your content */}
            ...
            <section className="py-12 text-center border-t">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Create applications that feel native on every device, from mobile
                phones to desktop workstations, with minimal code and maximum flexibility.
              </p>
