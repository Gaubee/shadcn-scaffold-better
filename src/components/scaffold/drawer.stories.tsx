...
function DrawerDemo({ side = "left" }: { side?: "left" | "right" }) {
  ...
  return (
    <div>
      <button onClick={() => setOpen(true)} className="px-4 py-2 bg-primary text-primary-foreground rounded-md m-4">
        Open {side} Drawer
      </button>
      ...
      <div>
        ...
        <Drawer open={open} onOpenChange={setOpen} width={400}>
          <div className="p-6">
            ...
            <p className="text-muted-foreground mb-4">This drawer is 400px wide instead of the default 280px.</p>
