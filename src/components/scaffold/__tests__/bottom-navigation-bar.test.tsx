...
describe("BottomNavigationBar", () => {
  ...
  it('shows only selected label when showLabels is "selected"', () => {
    render(<BottomNavigationBar items={mockItems} showLabels="selected" value="home" />);
  ...
  it("highlights selected item", () => {
    const { container } = render(<BottomNavigationBar items={mockItems} value="search" />);
  ...
  it("calls onValueChange when item is clicked", () => {
    ...
    render(<BottomNavigationBar items={mockItems} value="home" onValueChange={handleChange} />);
  ...
  it("does not call onValueChange for disabled items", () => {
    ...
    render(<BottomNavigationBar items={itemsWithDisabled} value="home" onValueChange={handleChange} />);
  ...
  it("renders badges on items", () => {
    const itemsWithBadges = [{ ...mockItems[0], badge: 5 }, { ...mockItems[1], badge: "99+" }, mockItems[2]];
  ...
  it("applies correct elevation classes", () => {
    const { container, rerender } = render(<BottomNavigationBar items={mockItems} elevation={0} />);
  ...
  it("handles hideOnScroll prop", () => {
    const { container } = render(<BottomNavigationBar items={mockItems} hideOnScroll />);
  ...
  it("applies custom className", () => {
    const { container } = render(<BottomNavigationBar items={mockItems} className="custom-class" />);
