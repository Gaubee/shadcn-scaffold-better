...
describe('NavigationRail', () => {
  ...
  it('highlights selected item with indicator', () => {
    const { container } = render(
      <NavigationRail items={mockItems} value="search" />
    );
  ...
  it('renders header content', () => {
    render(
      <NavigationRail
        items={mockItems}
        header={<div data-testid="rail-header">Logo</div>}
      />
    );
  ...
  it('renders footer content', () => {
    render(
      <NavigationRail
        items={mockItems}
        footer={<div data-testid="rail-footer">Settings</div>}
      />
    );
  ...
  it('applies custom width', () => {
    const { container } = render(
      <NavigationRail items={mockItems} width={120} />
    );
  ...
  it('applies correct elevation classes', () => {
    const { container, rerender } = render(
      <NavigationRail items={mockItems} elevation={0} />
    );
  ...
  it('applies custom className', () => {
    const { container } = render(
      <NavigationRail items={mockItems} className="custom-rail" />
    );
